 ...
 //  }
   ...
   // Call All Fuction 
    public static void main (String args[]) {
        ...
        System.out.println("Fuction Overloading Using  DataTypes For Int : " + sum(3,5));
        System.out.println("Function Overloading Using DataTypes For Float : " + sum(5.5f,5.5f));
    }
}